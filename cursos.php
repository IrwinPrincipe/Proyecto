...
<body class="site-section">
    ...
    <table >
        ...
        <tbody>
            ...
            <tr >
                ...
                <td class="stil_mod_elim0"><a href="modcurso.php? id=<?php echo $row['ID']; ?>">Modificar</a></td>
                <td class="stil_mod_elim00"><a href="eliminarcurso.php?id=<?php echo $row['ID']; ?>">Eliminar</a></td>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h4 class="text-right">Agregar Cursos</h4>
                </div>
                <div class="col-md-4"><a class="btn btn-primary btn-block" role="button" href="crearcurso.html">Agregar</a></div>
            </div>
        </div>
    </div>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h4 class="text-right">Modificar Curso</h4>
                </div>
                <div class="col-md-4"><a class="btn btn-primary btn-block" role="button" href="modcurso.html">Modificar</a></div>
            </div>
        </div>
    </div>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h4 class="text-right">Eliminar Curso</h4>
                </div>
                <div class="col-md-4"><a class="btn btn-primary btn-block" role="button" href="eliminarcurso.html">Eliminar</a></div>
            </div>
        </div>
    </div>
